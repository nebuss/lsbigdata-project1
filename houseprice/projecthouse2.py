...
sample=pd.read_csv("houseprice/data/sample_submission.csv")

## 이상치 탐색
# house_train=house_train.query("GrLivArea <= 4500")

# 범주형 변수인 Neighborhood 를 dummies로
...
house_train['Neighborhood'].values
...
neighborhood_dummies_test.isna().sum()
...
# 
# # csv 파일로 내보내기
# sub_df.to_csv("houseprice/data/houseprice9.csv", index=False)
